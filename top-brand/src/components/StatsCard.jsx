...
const StatsCard = () => {
    ...
    return (
       <div className='md:w-full xl:w-[90%] m-auto h-fit flex flex-row items-center justify-evenly flex-wrap md:grid grid-cols-2 lg:flex'>
            <div className='w-85 p-2 sm:pl-0 h-60 flex flex-col items-start justify-evenly'>
                <div ref={(el) => (countersRef.current[0] = el)} data-target="98" data-symbol="%" className='text-7xl font-modern-negra text-primary'>0%</div>
           ...
           <div className='w-85 p-2 sm:pl-0 h-60 flex flex-col items-start justify-evenly'>
                <div ref={(el) => (countersRef.current[1] = el)} data-target="20" data-symbol="+" className='text-7xl font-modern-negra text-primary'>0+</div>
           ...
           <div className='w-85 p-2 sm:pl-0 h-60 flex flex-col items-start justify-evenly'>
                <div ref={(el) => (countersRef.current[2] = el)} data-target="100" data-symbol="+" className='text-7xl font-modern-negra text-primary'>0+</div>
