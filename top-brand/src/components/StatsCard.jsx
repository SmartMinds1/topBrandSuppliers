...
const StatsCard = () => {
    ...
    return (
       <div className='w-[90%] m-auto h-fit flex-row-center justify-evenly flex-wrap bg-bg'>
           ...
           <div className='w-85 p-2 h-60 flex flex-col items-start justify-evenly'>
                <div ref={(el) => (countersRef.current[1] = el)} data-target="20" data-symbol="+" className='text-7xl font-modern-negra text-teal-700'>0+</div>
           ...
           <div className='w-85 p-2 h-60 flex flex-col items-start justify-evenly'>
                <div ref={(el) => (countersRef.current[2] = el)} data-target="100" data-symbol="+" className='text-7xl font-modern-negra text-teal-700'>0+</div>
