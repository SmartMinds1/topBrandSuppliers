...
const LandingHeader = ()=> {
  ...
  const count = cartItems.reduce((t, i) => t + i.qty, 0);
    ...
    return(
      <>
        <div className="w-full h-12 m-auto flex-row-end justify-between sm:h-13 fixed top-0 left-0 z-50 p-2 pl-[5%] pr-[5%] backdrop-blur-[5px] bg-[#ffffff7c]">
           {/*  logo */}
            <div className="w-40 flex flex-row items-end justify-center">
                <div className="w-9 h-9  flex-col-center justify-start mr-0.5 bg-[#111111]">{/* bg-[#111111] */}
