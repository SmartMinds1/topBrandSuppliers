...
const Alert = ({children, onClose})=>{
    ...
    return(
        <div className="w-40 bg-white rounded-2xl shadow-xl px-8 py-10 flex flex-col items-center gap-4 min-w-[280px]">
            ...
            <button className="w-16 h-8 rounded-2xl bg-primary text-bg-light text-sm hover:brightness-75 transition-all duration-300 cursor-pointer" onClick={onClose} >OK</button>
        </div>
    );
}
