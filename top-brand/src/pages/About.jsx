...
{/* ------------------SECTION 1 ------------------------- */}
      <div className='w-full h-[90vh] mt-16  flex-col-center justify-evenly'>
        <p className='w-[54%] h-fit text-maintext text-5xl font-bold leading-18 text-center'>Connecting Africa To The World, One Quality<span className='font-light'> Shipment At A Time</span> </p>
...
{/* ------------------SECTION 2 ------------------------- */}
        <div className='h-fit w-full flex-row-center justify-evenly flex-wrap bg-bg'>
           {/* caption div */}
           <div className='w-full md:w-1/2 h-fit lg:h-110 p-2  lg:pt-20 '>
               <p className='headerText text-center md:text-left  m-auto'>Who we are</p>
               <p className="sideBodyText"> Topbrand suppliers is a new and ambitious company dedicated to bridging African markets with reliable shipping and sourcing solutions. 
...
{/* ------------------SECTION 2 ------------------------- */}
        <div className='h-fit w-[95%] lg:pl-20 m-auto  flex-row-center justify-evenly flex-wrap'>
           {/* Mission div */}
           <div className='w-full md:w-[45%]  bg-bg-dark p-8 rounded-xl'>
